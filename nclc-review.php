           ...
           <div class="nclc-review__photos-container">
                <div class="first one-third">
                    <div class="nclc-review__small-photo-container">
                        <img alt="Katie Fahey" src="https://www.americanpromise.net/wp-content/uploads/2019/11/Katie-Fahey-podium-scaled-e1574092635154.jpg"/>
                        <span>Katie Fahey, Executive Director of The People, speaks at the conference.</span>
                    </div>
                    <div class="nclc-review__small-photo-container">
                        <img src="https://www.americanpromise.net/wp-content/uploads/2019/11/Doris-Kearns-Goodwin-book-signing-youth-scaled-e1574092923667.jpg"/>
                        <span>Presidential Historian Doris Kearns Goodwin signs copies of her book for two attendees.</span>
                    </div>
                </div>
                <div class="two-thirds">
                    <div class="nclc_review__collage-container--right">
                        <div class="nclc_review__image-container"><img width="100%" atl="Manu Meel" src="https://www.americanpromise.net/wp-content/uploads/2019/11/manu-portrait.png"></div>
    ...
    <div class="nclc-review__section-2 nclc-review__parallax nclc-review__parallax--teal">
        <div class="nclc-review__container">
            ...
            <div class="nclc-review__photos-container">
                <div class="first two-thirds">
                    <div class="nclc_review__collage-container--left">
                        <div class="nclc_review__image-container"><img width="100%" src="https://www.americanpromise.net/wp-content/uploads/2019/11/curran-portrait.png"></div>
                        <div class="nclc_review__card-container">
                ...
                <div class="one-third">
                    <div class="nclc-review__small-photo-container">
                        <img src="https://www.americanpromise.net/wp-content/uploads/2019/11/Heather-Santos-Podium.jpg"/>
                        <span>Citizen Leader Heather Santos delivers a testimonial at the conference.</span>
                    </div>
                    <div class="nclc-review__small-photo-container">
                        <img src="https://www.americanpromise.net/wp-content/uploads/2019/11/Steven-Miller-Barbara-Miller-Joan-Divor-Hats-off-citizen-leaders-scaled-e1574096383637.jpg"/>
                        <span>Citizen Leaders give a 'Hats Off' to the NCLC.</span>
                    </div>
                </div>
            </div>
            ...
            <div class="nclc-review__button-row">
                ...
                <div class="one-fourth"><a target="_blank" href="https://www.youtube.com/watch?v=4at0vYmfclY&feature=youtu.be" class="nclc-review__button nclc-review__button--purple">Video: Corinne Dodge Accepts Her Citizen Leader Award</a></div>
            </div>
            <div class="nclc-review__video-row">
                <div class="first one-half video-spacer">
                    <div class="video-container">
    ...
    <div class="nclc-review__section-3">
        <div class="nclc-review__container">
            ...
            <div class="nclc-review__photos-container">
                <div class="first one-third">
                    <div class="nclc-review__small-photo-container">
                        <img atle="Cheryl Crawford, Executive Director of MassVOTE and Matt Cox, NC State Senate Candidate" src="https://www.americanpromise.net/wp-content/uploads/2019/11/Cheryl-Crawford-Matt-Cox.jpg"/>
                        <span>Cheryl Crawford, Executive Director of MassVOTE (Left) and Matt Cox, NC State Senate Candidate (Right).</span>
                    </div>
                    <div class="nclc-review__small-photo-container">
                        <img alt="Courtney Hight, Rod Morrison, Elizabeth Doty" src="https://www.americanpromise.net/wp-content/uploads/2019/11/Courtney-Hight-Rod-Morrison-Elizabeth-Doty-scaled-e1574100106801.jpg"/>
                        <span>Courtney Hight, Director, Democracy Program of the Sierra Club (left), Rod Morrison, Wyoming Promise (center), Elizabeth Doty, Founder of Leadership Momentum and National Program Coordinator of Business for American Promise (right)</span>
                    </div>
                </div>
                <div class="two-thirds">
                    <div class="nclc_review__collage-container--right">
                        <div class="nclc_review__image-container"><img width="100%" src="https://www.americanpromise.net/wp-content/uploads/2019/11/Ellen-Read-Portrait.png"></div>
                        <div class="nclc_review__card-container">
                            <div class="nclc_review__quote-card">
            ...
            <div class="nclc-review__video-row">
                ...
                <div class="one-half video-spacer">
                    ...
                    <span class="nclc-review__video-caption">Fmr. State Senator Jim Ruben (R - New Hampshire) shares why conservatives care just as deeply about money in politics as anyone else.</span>
                </div>
            </div>
    ...
    <div class="nclc-review__section-4 nclc-review__parallax nclc-review__parallax--purple">
        <div class="nclc-review__container">
            ...
            <div class="nclc-review__photos-container">
                ...
                <div class="one-third">
                    <div class="nclc-review__small-photo-container">
                        <img src="https://www.americanpromise.net/wp-content/uploads/2019/11/TX-Rep.-Van-Taylor-David-Stringfellow-e1574105229579.jpg"/>
                        <span>Citizen Leader David Stringfellow meets with Congressman Van Taylor (R - Texas)</span>
                    </div>
                    <div class="nclc-review__small-photo-container">
                        <img src="https://www.americanpromise.net/wp-content/uploads/2019/11/IMG_3941.jpg"/>
                        <span>Citizen Leaders gather at the capital.</span>
                    </div>
                </div>
            </div>
            ...
            <div class="nclc-review__button-row">
                ...
                <div class="one-fourth"><a target="_blank" class="nclc-review__button nclc-review__button--white">NEEDS CONTENT</a></div>
                <div class="one-fourth"><a target="_blank" class="nclc-review__button nclc-review__button--white">NEEDS CONTENT</a></div>
            </div>
            <div class="nclc-review__video-row">
                <div class="first one-half video-spacer">
                    ...
                    <span class="nclc-review__video-caption">Citizens from all over the country joined together to meet with their members of Congress to ask them to support a 28th Amendment to get money out of politics. First stop: delivering the message of our time from the people of New Hampshire, the legislature of New Hampshire, to the New Hampshire delegation in Congress. </span>
                </div>
                <div class="one-half video-spacer">
                    <div class="video-container">
