    ...
    <div class="grid" style="margin:0 auto;">
        <div class="grid-item">
            <figure class="testimonial-card">
                <blockquote>The flood of money into politics has deepened divisions between us and distracted our political leadership from the common good. We cannot wait for a change in the makeup of the Supreme Court to fix this. American Promise offers us a way to refocus our democracy on involving all and serving all the people, and I am proud to join its advisory board.</blockquote>
                <div class="council-member">
                    <img src="https://americanpromise.net/wp-content/uploads/2021/01/D.Patrick.png" alt="Patrick"/>
                    <h5>Deval Patrick<span>Former Governor Massachusetts, 2007-2015</span><span>Boston, MA</span></h5>
                </div>
            </figure>
        </div>
        <div class="grid-item">
        ...
        <div class="grid-item">
            <figure class="testimonial-card">
                <blockquote>America goes to war for crony capitalism not freedom, democracy, or the spread of human rights, not even for our own security...America needs to eliminate this pernicious connection -- to dry up the money that greases it, to get rid of the laws that sustain it, to take crony capitalism's money out of politics.</blockquote>
                <div class="council-member">
                    <img src="https://americanpromise.net/wp-content/uploads/2021/01/12.png" alt="Wilkerson"/>
                    <h5>Col. Lawrence Wilkerson<span>US Army (Ret.)-fmr. Chief of Staff, US Secretary of State Gen. Colin Powell</span><span>Williamsburg, VA</span></h5>
                </div>
            </figure>
        </div>
        ...
        <div class="grid-item">
            <figure class="testimonial-card">
                <blockquote>It's time for moral leadership within our businesses, our communities and our government that will return to fair competition, checks and balances, and accountability.</blockquote>
                <div class="council-member">
                    <img src="https://americanpromise.net/wp-content/uploads/2021/01/M.-Howland.png" alt="Howland"/>
                    <h5>MaryAnne Howland<span>Founder & CEO, Ibis Communications and Global Diversity Leadership Exchange</span><span>Gallatin, TN</span></h5>
                </div>
            </figure>
        </div>
        ...
        <div class="grid-item">
            <figure class="testimonial-card">
                <blockquote>Without taking money out of politics, we will never address the great problems of our time. Business must recognize that free markets need free politics, and must play a significant role in driving this change.</blockquote>
                <div class="council-member">
                    <img src="https://americanpromise.net/wp-content/uploads/2021/01/R.-Henderson.png" alt="Henderson"/>
                    <h5>Rebecca Henderson<span>John & Natty McArthur Professor, Harvard Business School</span><span>Cambridge, MA</span></h5>
                </div>
            </figure>
        </div>
        ...
        <div class="grid-item">
            <figure class="testimonial-card">
                <blockquote>As the founder of a small business servicing venture capital firms, I see that corporate election spending hurts innovators and allows companies to gain choke-holds over the economy. Unlimited election spending is bad for business!</blockquote>
                <div class="council-member">
                    <img src="https://americanpromise.net/wp-content/uploads/2021/01/Kevin-Johnson.png" alt="Johnson"/>
                    <h5>Kevin Johnson<span>CEO, Liberty Global Partners</span><span>Waban, MA</span></h5>
                </div>
            </figure>
        </div>
        ...
        <div class="grid-item">
            <figure class="testimonial-card">
                <blockquote>We must change the warped incentives in our political system, and limitless campaign finances are an important part of the problem.</blockquote>
                <div class="council-member">
                    <img src="https://americanpromise.net/wp-content/uploads/2021/01/9.png" alt="Simon"/>
                    <h5>Neal Simon<span>fmr. CEO; Independent US Senate candidate</span><span>Potomac, MD</span></h5>
                </div>
            </figure>
        </div>
        ...
        <div class="grid-item">
            <figure class="testimonial-card">
                <blockquote>As an average Mainer, it is nearly impossible to compete with billionaires, but what they can’t buy with money is the deep love and passion we feel for the outdoors and the freedom our Constitution guarantees.</blockquote>
                <div class="council-member">
                    <img src="https://americanpromise.net/wp-content/uploads/2021/01/10.png" alt="Trahan"/>
                    <h5>David Trahan<span>Executive Director, Sportsman’s Alliance of Maine; fmr. Maine Rep.; fmr. Maine Senator</span><span>Waldoboro, ME</span></h5>
                </div>
            </figure>
        </div>
        <div class="grid-item">
            <figure class="testimonial-card">
                <blockquote>We now have a republic that is not representative of nor responsive to the general public. We need a number of Constitutional Amendments to revitalize our republic, including campaign finance, fiscal responsibility and term limits amendments.</blockquote>
                <div class="council-member">
                    <img src="https://americanpromise.net/wp-content/uploads/2021/01/11.png" alt="Walker"/>
                    <h5>David Walker<span>United States Comptroller General (1998-2008); U.S. Naval Academy, Crowe Chair</span><span>Alexandria, VA</span></h5>
                </div>
            </figure>
        </div>
        <div class="grid-item">
            <figure class="testimonial-card">
                <blockquote>I am honored to be a part of an organization devoted to bringing people together in order to reform our democracy. As someone with a passion for working on teams that are building momentum for new ideas and new ways of doing things, I am eager to unite all Americans around the need for the 28th Amendment.</blockquote>
                <div class="council-member">
                    <img src="https://americanpromise.net/wp-content/uploads/2021/01/M.Cox_.png" alt="Cox"/>
                    <h5>Matthew Cox<span>US Navy, Nuclear Submarine Operations Officer (2008-2014); VP, Global Data Consortium</span><span>Raleigh, NC</span></h5>
                </div>
            </figure>
        </div>
