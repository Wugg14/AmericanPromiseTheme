...
<i><p>
  ...
  <ol>
    <li><strong>Join.</strong> Join your local BAP <a href="https://www.americanpromise.net/take-action/join-a-program/business-for-american-promise/building-a-national-network/">chapter</a>, and gain access to tools and support that enable you to take effective action with a minimum investment of time. Or, gather with a few colleagues and <a href="https://www.americanpromise.net/take-action/join-a-program/business-for-american-promise/start-a-chapter/">start a new chapter</a> in your area.</li>
    <li><strong>Sign.</strong> Sign our non-partisan Statement of Principle to show your support for honest competition, representative democracy and integrity in government.</li>
    <li><strong>Share.</strong> Tap your network and help us articulate the business case for solving pay-to-play politics. Convene a salon with trusted colleagues, host an event with your business school alumni group or write a letter to the editor. By <a href="https://www.americanpromise.net/take-action/join-a-program/business-for-american-promise/share/">adding your name</a> to our local list, you will receive updates and access to BAP tools so you can have an impact with a limited investment of time. </li>
  </ol>
  <p>
